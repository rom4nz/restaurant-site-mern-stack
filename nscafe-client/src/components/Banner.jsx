      ...
      <div className='py-24 flex flex-col md:flex-row-reverse justify-between items-center gap-8'>
        ...
        <div className='md:w-1/2'>
          ...
          <div className='flex flex-col md:flex-row items-center justify-around -mt-14 gap-4'>
            <div className='flex bg-white py-2 px-3 rounded-2xl items-center gap-3 shadow-md sm:w-64 md:w-72'>
              ...
              <div className='space-y-1'>
                ...
                <div className="rating rating-sm">
                  ...
                  <input type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" readOnly/>
                  <input type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" readOnly defaultChecked/>
                  <input type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" readOnly/>
                  <input type="radio" name="rating-2" className="mask mask-star-2 bg-yellow-500" readOnly/>
                </div>
            ...
            <div className='sm:flex hidden bg-white py-2 px-3 rounded-2xl items-center gap-3 shadow-md w-72'>
              <img src='/images/home/image 13.png' alt='' className='rounded-2xl' />
              <div className='space-y-1'>
